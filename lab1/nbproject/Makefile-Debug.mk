...
# CC Compiler Flags
CCFLAGS=-m64 -g3 -pg -O0
CXXFLAGS=-m64 -g3 -pg -O0
...
${OBJECTDIR}/tgaimage.o: tgaimage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Werror -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tgaimage.o tgaimage.cpp

${OBJECTDIR}/welcome.o: welcome.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Werror -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/welcome.o welcome.cc
